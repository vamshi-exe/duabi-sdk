...
#ifndef CCAVENUEUAEVERTICAL_SWIFT_H
#define CCAVENUEUAEVERTICAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CCAvenueUaeVertical",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19CCAvenueUaeVertical20CCMainViewController")
@interface CCMainViewController : UIViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
/// handle to collection-view layout while change in orientation
...
@interface CCMainViewController (SWIFT_EXTENSION(CCAvenueUaeVertical)) <UIPopoverPresentationControllerDelegate>
...
SWIFT_CLASS("_TtC19CCAvenueUaeVertical28UICustomCollectionViewLayout")
@interface UICustomCollectionViewLayout : UICollectionViewLayout
...
SWIFT_CLASS("_TtC19CCAvenueUaeVertical15ValidationError")
